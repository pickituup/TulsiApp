    ...
    public partial class SideMenuView : SlideOverKit.SlideMenuView {
        public SideMenuView() {
            ...
            MenuTap1.Tapped += (s, e) => {
                ...
                BaseSingleton<ViewSwitchingLogic>.Instance.NavigateTo(ViewType.DashboardPage);
            };
            ...
            MenuTap2.Tapped += (s, e) => {
                ...
                BaseSingleton<ViewSwitchingLogic>.Instance.NavigateTo(ViewType.GrowerPage);
            };
            ...
            TapGestureRecognizer profitPageMenuTap8 = new TapGestureRecognizer();
            profitPageMenuTap8.Tapped += (s, e) => {
                // remove that.
            ...
            SideMenuHeaderProfitIcon.GestureRecognizers.Add(profitPageMenuTap8);
        }
    }
}